...
4. Двухнедельный курс Мастерская писателя (17 – 30 июля ). Программа. Кейсы. Отзывы.
    """
    ...
    image_path = r'C:\Users\Кирилл\Desktop\photo_2023-09-23_14-50-14.jpg'
...
def bt2(call):
    ...
    proggggg = """
         Мастерская писателя Анны Никольской «Путь лёгкости». 35-й сезон пройдёт с 2 по 15 октября. 
