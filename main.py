...
def bt(call):
    ...
    welcome_message = (
        ...
        "А сейчас можете ознакомиться с программой нового сезона двухнедельной Мастерской писателя (15-28 апреля)."
    )
...
def bt2(call):
    ...
    proggggg = """
         Мастерская писателя Анны Никольской. 38-й сезон пройдет с 15 по 28 апреля 
